...
xbm_t ScrSaverXBM = {
  ...
  .height=60,
  .xbm=(const uint8_t[]){
  ,
...
#ifdef SCREENSAVER
  if(!(screenSaver.enabled||systemSettings.settings.screenSaver) || getCurrentMode() !=mode_sleep || (getIronErrorFlags().active)){
    return;
  }
  if(current_time-screenSaver.timer>25){
    screenSaver.timer=current_time;
    screenSaver.x+=screenSaver.xAdd;
    screenSaver.y+=screenSaver.yAdd;
    if(screenSaver.x<-5 || screenSaver.x>(displayWidth-ScrSaverXBM.width+5)){
      screenSaver.xAdd = -screenSaver.xAdd;
    }
    if(screenSaver.y<-5 || screenSaver.y>(displayHeight-ScrSaverXBM.height+5)){
  ...
  switch(mainScr.currentMode){
    ...
    case main_tipselect:
      ...
      switch((uint8_t)input){
        ...
        {
          uint8_t tip = 0;
          uint8_t activeTips[systemSettings.Profile.currentNumberOfTips];
          uint8_t numOfActiveTips=0;
          for(uint8_t i=0; i<systemSettings.Profile.currentNumberOfTips;i++)
          {

        	  if(systemSettings.Profile.tip[i].active)
        	  {
        		  activeTips[numOfActiveTips]=i;
        		  if(systemSettings.currentTip==i) tip=numOfActiveTips;
        		  ++numOfActiveTips;
        	  }
          }

          if(numOfActiveTips>0)
          {
              if(input==Rotate_Increment_while_click || input==Rotate_Increment){
                if(++tip >= numOfActiveTips){
                  tip=0;
                }
              }
              else if(input==Rotate_Decrement_while_click || input==Rotate_Decrement){
                if(--tip>=numOfActiveTips){          // If underflowed
                  tip = numOfActiveTips-1;
                }
              }
        	  if(activeTips[tip]!=systemSettings.currentTip)
        	  {
				__disable_irq();
				setCurrentTip(activeTips[tip]);
				__enable_irq();
				Screen_main.state=screen_Erase;
        	  }
          }
...
#ifdef SCREENSAVER
  if(!(screenSaver.enabled||systemSettings.settings.screenSaver) || getCurrentMode()!=mode_sleep || mainScr.currentMode!=main_irontemp){
      return 0;
  }
  ssActive=1;
  if(!refresh)
...
static uint8_t main_screen_draw(screen_t *scr){
  ...
  ssActive=0;
    if(mainScr.ironStatus != status_error){
      ret |= drawScreenSaver(refresh); //ssActive is set here

    }
    //if((getCurrentMode()!=mode_sleep)||(!(screenSaver.enabled||systemSettings.settings.screenSaver)))
    if(!ssActive)
    {
